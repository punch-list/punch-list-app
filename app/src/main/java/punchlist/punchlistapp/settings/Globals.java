...
public class Globals {
    ...
    public void prepopulateDb() {
        ...
        if (Item.getItems().isEmpty()) {
            ...
            items.add(new Item("Drake 2-piece", "", 216, 4, null, PLComponent.getComponentByFakeId(Globals.TOILET), 550, 223, "toilet1", mResources));
            items.add(new Item("Memoirs Stately 2-piece", "A slightly more luxurious throne", 349, 4, null, PLComponent.getComponentByFakeId(Globals.TOILET), 550, 223, "toilet2", mResources));

            items.add(new Item("Solerno Moderna", "", 2, 0, null, PLComponent.getComponentByFakeId(Globals.TILE), 300, 300, "tile1", mResources));
            items.add(new Item("Daltile Porcelain", "", 3, 0, null, PLComponent.getComponentByFakeId(Globals.TILE), 300, 300, "tile2", mResources));

            items.add(new Item("Purple Periwinkle", "", 25, 0, null, PLComponent.getComponentByFakeId(Globals.PAINT), EditProjectActivity.FLOORPLAN_WIDTH, EditProjectActivity.FLOORPLAN_HEIGHT, "paint2", mResources));
            items.add(new Item("Balboa Mist", "", 55, 0, null, PLComponent.getComponentByFakeId(Globals.PAINT), EditProjectActivity.FLOORPLAN_WIDTH, EditProjectActivity.FLOORPLAN_HEIGHT, "paint1", mResources));

            items.add(new Item("Hillsbury 36\"", "", 577, 0, null, PLComponent.getComponentByFakeId(Globals.SINK), 160 * 2, 420 * 2, "sink1", mResources));
            items.add(new Item("Vinnova Gela 36\"", "", 1073, 0, null, PLComponent.getComponentByFakeId(Globals.SINK), 160 * 2, 420 * 2, "sink2", mResources));

            items.add(new Item("Sterling Ensemble", "", 235, 0, null, PLComponent.getComponentByFakeId(Globals.BATHTUB), 500 * 3, 126 * 3, "bathtub1", mResources));
            items.add(new Item("Kohler K-1123-RA-0", "", 646, 0, null, PLComponent.getComponentByFakeId(Globals.BATHTUB), 500 * 3, 126 * 3, "bathtub2", mResources));
